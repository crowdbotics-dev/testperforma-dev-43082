...
## Project Structure
    ...
    ├── testperforma_dev_43082  # Django project configurations
...
1. Clone this repo and `cd testperforma_dev_43082`
...
2. Clone this repo and `cd testperforma_dev_43082`
